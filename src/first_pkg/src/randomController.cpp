...
randomController::randomController() : Node ("randomController"){
  ...
  publisher_=this->create_publisher<std_msgs::msg::String>("/cmd_random",10);
}
...
void randomController::publish_method(){
